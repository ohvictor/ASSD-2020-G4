...
\begin{titlepage}
    ...
    \textsc{\large Gu\'ia de Problemas N°1}\\[0.5cm] % Minor heading such as course title
    ...
    \HRule \\[0.5cm]
    \textsc{ \huge  Sistemas  discretos}\\[0.4cm] % Title of your document
    \HRule \\[2cm]
   ...
   Agust\'in Ignacio \textsc{Galdeman}\\
    ...
    \vfill
    {\large Entregado: 31 de marzo de 2020}\\[2cm] % Date, change the \today to a set date if you want to be precise
